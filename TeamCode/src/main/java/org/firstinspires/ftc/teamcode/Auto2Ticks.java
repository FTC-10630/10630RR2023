...
@Autonomous(name="Auto2Ticks", group="Robot")
public class Auto2Ticks extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // RED -- RIGHT ZONE
        if (webcamResponce == 0) {
            strafeRight(LOW_SPEED, TILE - 11.7 - 1);
        }
        // GREEN -- CENTRE ZONE
        else if (webcamResponce == 1) {
            strafeLeft(LOW_SPEED, 11.7);
        }
        // BLUE -- LEFT ZONE
        else if (webcamResponce == 2) {
            strafeLeft(LOW_SPEED, 11.7 + TILE + 1);
        }
        // ERROR
