...
@Autonomous
public class DunkaMind extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose =new Pose2d(35.50, -60.70, Math.toRadians(90.00)); //this rotation might be off
        //-31 inches
        drive.setPoseEstimate(startPose);
        TrajectorySequence untitled0 = drive.trajectorySequenceBuilder(new Pose2d(35.50, -60.70, Math.toRadians(90.00)))
